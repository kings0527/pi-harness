...
用户维护 [StructFlow](/home/me/me/money/structflow)（证据优先的 L0-L7 结构化投研 skill，
执行契约在其 `SKILL.md`）。近期对该项目做了一次 Harness 评审（报告：
`/home/me/me/money/structflow/.qoder/better-harness/2026-07-31/185817-structflow/`），
核心结论：
...
| 项 | 事实 |
|---|---|
| 版本/位置 | pi 0.83.0，`/home/me/.npm-global/bin/pi` |
...
2. 把 StructFlow 挂载为 pi skill：优先 `pi install /home/me/me/money/structflow -l`
...
```bash
cd /home/me/git/pi-harness
git init   # 若尚未初始化
pi --version                                   # 确认引擎可用
pi install /home/me/me/money/structflow -l    # P0-2：项目局部挂载 skill
